...
namespace AIShell.Domain.Common.Utils
{
    public static class ConvertUtils
    {
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static string ReplaceHtmlCode(this string s)
        {
        ...
        {
            string plainText = Regex.Replace(s, "<.*?>", String.Empty);
            return plainText;
        }
        ...
        public static string MarkDownToHtml(this string value)
        {
            string html = Markdown.ToHtml(value);
            if (html.Contains("<img src="))
            {
                html=html.Replace("<img src=", "<img width=\"100%\" src=");
            }
